...
<tags:template>
    ...
    <jsp:body>
        <div style="float:right;"><a href="<c:out value="j_spring_security_logout" />" >Logout</a></div>
        ...
        <ul>
            ...
            <li>A few JSP pages that renders the views with <code>template.tag</code> template file and
                <code>layout.css</code>
        </ul>
        <p><a href="myentity/-1">Create a <code>MyEntity</code> Record</a></p>
    </jsp:body>
</tags:template>
